      ...
      <div class="col-md-12">
        <div class="widget box">
          <div class="widget-header">
            <h4><i class="fa fa-plus-square"></i> Edit Subcategory</h4>
          </div>
          <div class="widget-content">
            <div class="col-xs-12 col-sm-12">
              ...
              {{ Form::open(array('url' => 'edit-subcategory', 'role' => 'form', 'class' =>'form-horizontal row-border', 'name' => 'frm_category', 'id' => 'frm_category','files'=>true, 'autocomplete' => 'off')) }}
              {!! Form::hidden('reference_id',$subcate_data->sub_cat_id) !!}
              <div class="form-group col-md-8">
                <label>Category Name*:</label>
                {{ Form::select('cat_id', $data, $subcate_data->cat_id, ['id' => 'cat_id','class'=>'form-control','required']) }}
              </div>
              <div class="form-group col-md-8">
                <label>Subcategory Name*:</label>
                {!! Form::text('sub_cat_name',$subcate_data->sub_cat_name,array('id' => 'sub_cat_name','required','class'=>'form-control','placeholder'=>'')) !!} 
              </div>
