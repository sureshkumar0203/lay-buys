<header class="header navbar navbar-fixed-top" role="banner">
    <div class="container">
        ...
        <a class="navbar-brand" href="{{ URL::to('administrator/dashboard') }}"><!--<img src="{{ URL::asset('public/images/logo.jpg') }}" height="" width="" alt="logo"/>-->Lay Buys<strong> Admin</strong></a>
