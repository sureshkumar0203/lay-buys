    ...
    <div class="row">
        <div class="col-md-12">
            <div class="widget box">
                <div class="widget-header"><h4><i class="fa fa-pencil-square-o"></i> Edit Color</h4> </div>
                <div class="widget-content">
                    <div class="col-xs-12 col-sm-12">
                      ...
                      {{ Form::open(array('url' => 'update-color', 'role' => 'form', 'class' =>'form-horizontal row-border', 'name' => 'frm_color', 'id' => 'frm_color','files'=>true, 'autocomplete' => 'off')) }}  
                     ...
                     {!! Form::text('color_name',$data[0]->color_name,array('id' => 'color_name','required','class'=>'form-control','placeholder'=>'')) !!}
                     </div>
                     
                     <script type="text/javascript" src="{{  asset('public/jscolor/jscolor.js') }}"></script>
                     <div class="form-group col-md-8">
                      <label>Select Color*:</label> 
                     {!! Form::text('color_code',$data[0]->color_code,array('id' => 'color_code','required','class'=>'form-control color','placeholder'=>'','readonly' => 'true')) !!}
                     </div>
