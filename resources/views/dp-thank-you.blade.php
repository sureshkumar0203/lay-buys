    ...
    <div class="row thank-you">
      ...
      <div class="col-md-12 col-sm-12 mt-35">
        <div class="entry-content">
         <h2 style="color:#060;">Thank You for your order.</h2>
		 <a href="{{url('/')}}/my-account"><strong>Click here</strong> </a><strong> to view your order details in your account</strong>.<br /><br />
        </div>
      </div>
    </div>
  </div>
